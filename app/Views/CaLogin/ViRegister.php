...
>
  ...
  <body>
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2 text-center">¡Registrarse!</h4>

              <form id="frm-register" action="<?= base_url('register-validate'); ?>" >

                <div class="mb-3">
                  <label for="email" class="form-label">Nombre</label>
                  <input type="text" class="form-control" id="tx_nombre_usuario" name="tx_nombre_usuario" placeholder="Ingrese su Nombre" autofocus />
                </div>

                <div class="mb-3">
                  <label for="email" class="form-label">Apellido</label>
                  <input type="text" class="form-control" id="tx_apellido_usuario" name="tx_apellido_usuario" placeholder="Ingrese su Apellido"  />
                </div>

                <div class="mb-3">
                  <label for="email" class="form-label">Usuario</label>
                  <input type="text" class="form-control" id="tx_alias_usuario" name="tx_alias_usuario" placeholder="Ingrese su Usuario"  />
                </div>
                ...
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-100" type="submit"><b><i class="bx bx-log-in-circle me-1"></i>Registrase</b></button>
                </div>
              </form>
    ...
    <!-- Js Personalized -->
    <script type="text/javascript" src="<?php echo base_url(); ?>/js/IuViRegister.js"></script>
